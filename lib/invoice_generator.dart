...
class _InvoiceGeneratorScreenState extends State<InvoiceGeneratorScreen> {
  ...
  final double _scrollOffset = 0.0; // Przechowuje aktualny stan suwaka
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Data sprzedazy'),
              ),
              TextFormField(
                controller: _invoiceDateOfPaymentController,
                decoration: const InputDecoration(labelText: 'Data platnosci'),
              ),
              TextFormField(
